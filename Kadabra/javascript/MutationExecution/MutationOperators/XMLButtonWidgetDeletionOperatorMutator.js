...
export default class XMLButtonWidgetDeletionOperatorMutator extends Mutator {
    constructor(rootPath) {
        super("XMLButtonWidgetDeletionOperatorMutator");
    ...
    toString() {
        return `XML Button Widget Deletion Operator Mutator from ${this.previousValue} to ${this.mutationPoint}, current mutation points ${this.mutationPoints}, current mutation point ${this.mutationPoint} and previous value ${this.previousValue}`;
    }
