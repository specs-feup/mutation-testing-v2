...
export default class XMLEditTextWidgetChangeAppearanceOperatorMutator extends Mutator {
    constructor(rootPath) {

        super("XMLEditTextWidgetChangeAppearanceOperatorMutator");
    ...
    toString() {
        return `XML EditText Widget Change Appearance Operator Mutator from ${this.previousValue} to ${this.mutationPoint}, current mutation points ${this.mutationPoints}, current mutation point ${this.mutationPoint} and previous value ${this.previousValue}`;
    }
